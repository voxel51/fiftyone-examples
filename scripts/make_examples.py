...
{% for example in examples %}
    <tr>
        <td>
            <a target="_blank" href="https://colab.research.google.com/github/voxel51/fiftyone-examples/blob/master/{{ example.path }}">co</a> •
            <a target="_blank" href="https://nbviewer.jupyter.org/github/voxel51/fiftyone-examples/blob/master/{{ example.path }}">jp</a> •
            <a id="raw-url" href="https://raw.githubusercontent.com/voxel51/fiftyone-examples/master/{{ example.path }}" download>dn</a>
        </td>
